...
from dipoleMMSCountingSpec import *; 
...
def runSims(sims = 10,steps = 10,verbosity = 1,simIdent = 'Test'):
	...
	dataPackage = {'Meta':{'NumActs':numActs,'maxDepth':maxDepth,'c':c,'maxTreeQueries':maxTreeQueries,'maxTime':maxTime,'gamma':gamma,'numObs':numObs,'problemName':problemName,'fileName':'dipolePOMCP'},'Data':[]}
	...
	for count in range(0,sims):
		...
		print(""); 
		np.save('../data/dataDipole_E1_{}'.format(simIdent),dataPackage)
