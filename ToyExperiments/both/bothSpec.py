...
def generate_o(s,a):
	...
	if(a == 4):
		...
		if(word == 3 and coin > humanLike):
			return 'Yes'; 
		elif(word == 3 and coin < humanLike):
			return 'No'; 
		elif(word != 3 and coin > humanLike):
			return 'No';
		elif(word != 3 and coin < humanLike):
		...
		#asked 0
		coin = np.random.random(); 
		if(s[4] == 0 and coin > humanLike):
			return 'Yes'; 
		elif(s[4] == 0 and coin < humanLike):
			return 'No'; 
		elif(s[4] != 0 and coin > humanLike):
			return 'No';
		elif(s[4] != 0 and coin < humanLike):
		...
		#asked 1
		coin = np.random.random(); 
		if(s[4] == 1 and coin > humanLike):
			return 'Yes'; 
		elif(s[4] == 1 and coin < humanLike):
			return 'No'; 
		elif(s[4] != 1 and coin > humanLike):
			return 'No';
		elif(s[4] != 1 and coin < humanLike):
		...
		#asked 2
		coin = np.random.random(); 
		if(s[4] == 2 and coin > humanLike):
			return 'Yes'; 
		elif(s[4] == 2 and coin < humanLike):
			return 'No'; 
		elif(s[4] != 2 and coin > humanLike):
			return 'No';
		elif(s[4] != 2 and coin < humanLike):
	...
	#If no question asked, movement related sensing
	##flip coin for noise
	coin = np.random.random(); 
	if(coin < 0.01):
