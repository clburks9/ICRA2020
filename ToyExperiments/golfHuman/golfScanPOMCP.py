...
def runSims(sims = 10,steps = 10,verbosity = 1,simIdent = 'Test',vis=False):
	...
	for ac in acs:
		for av in avas:
			accuracy = ac; 
			availability = av; 
			print("Starting Data Collection Run, Acc: {}, Ava: {}".format(ac,av)); 
			...
			for count in range(0,sims):
				initialize(accuracy,availability); 
				numActs = 4; 
				...
				# print(""); 
				np.save('../../data/dataGolfScan_{}_{}_{}'.format(availability,accuracy,simIdent),dataPackage)
